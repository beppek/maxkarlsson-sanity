...
const Course = ({
  ...
  return (
    <article>
      <Title>{title}</Title>
      <SubHeading>
        {currentLesson + 1} – {lessons[currentLesson].title}
      </SubHeading>
      ...
      <BlogPostWrapper>
        <div>
          ...
          {completed ? (
            <>
              <p>Well done, you have completed this course!</p>
              <p>
                Check out <Link to="/courses">my other courses</Link> for more
                learning material.
              </p>
              <Button
                disableElevation
            ...
            <Lesson
              lastLesson={currentLesson === lessons.length - 1}
